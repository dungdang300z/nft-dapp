...
export default function NFTGallery({ nfts, loading, address, onRefresh }) {
  ...
  const filtered = nfts
    ...
    .sort((a, b) =>
      sort === "newest" ? Number(b.tokenId) - Number(a.tokenId) :
      sort === "oldest" ? Number(a.tokenId) - Number(b.tokenId) :
  ...
  return (
    <div className="gallery">
      ...
      {!address
        ? <div className="empty-state"><span className="empty-icon">🦊</span><p>Kết nối ví để xem NFT của bạn</p></div>
        : loading
